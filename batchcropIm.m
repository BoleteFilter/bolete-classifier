function result = batchcropIm(inDir, outDir)
%batchcropIm Batch process images using cropIm
% RESULT = batchcropIm(INDIR, OUTDIR) processes each file in INDIR
% using the function cropIm.
%
% The following fields from the output of cropIm are written with their
...
% Process each image using cropIm
